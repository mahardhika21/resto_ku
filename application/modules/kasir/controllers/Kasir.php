...
class Kasir extends MX_Controller
{
	function __construct()
	{
		...
		$this->load->model(array('M_kasir','M_reservation','M_menu'));
	...
	public function profile()
	{
		...
		$data = array(
			'message_status' => '',
			"profile"        => $this->M_kasir->get_profile($this->session->userdata('data_login')['username']),
			'title'          => 'Profile Admin',
			'part' => array(
				'header' 	=> $this->base->header('kasir'),
				'footer' 	=> $this->base->footer(),	
