                                    ...
                                    <tbody>
                                      ...
                                      ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php if($val['status_user'] == 'true') {echo "aktif";}else{ echo 'non-aktif';} ?></td>
                                            ...
                                            <a class="btn btn-warning btn-sm" href="<?php echo base_url() .'admin/backend/up_status_user/'.$val['id_user'].'/'.$stat; ?>"> <?php echo $txt; ?> <i class="fa fa-user fa-sm"></i></a>
                                            </td>
...
<?php } ?>
          ...
          <div class="form-group" style="margin-top: 12px;">
            ...
            <div class="col-md-8">
              <button type="submit" class="btn btn-info" style="margin-top: 12px; margin-bottom: 12px;">Add User</button>
            </div>
          </div>
        </form>
                              </div>
