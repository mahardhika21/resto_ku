             ...
             <div class="row">
                 ...
                 <div class="panel panel-primary " id="login_page">
                        ...
                        <div class="panel-body chat-widget-main">
                         <div class="jumbotron">
  <h4>Halaman DETAIL RESERVATION PELAYAN/WAITER</h4> 
</div>
        ...
        <h3>DETAIL PEMESANAN MAKANAN</h3>
        ...
        <form method="POST" class="form-horizontal" role="form" action="<?php echo site_url('kasir/backend/update_reserv'); ?>">
            ...
            <?php
             ...
             foreach ($detail_res as $dt){ 
              ...
              <div class="form-group" id="fm<?php echo $no; ?>">
                ...
                <label class="col-lg-3 control-label">Menu :</label> <div class="col-lg-5"><input type="text" class="form-control menu-list-data" readonly name="[list_menu]" data-id_menu="<?php echo $dt->id_menu; ?>" data-price="<?php echo $dt->det_price; ?>"  data-type_menu="<?php echo $dt->desc_reserv; ?>" value="<?php echo $dt->name_menu; ?>" id="nomor_menu"><a class="btn btn-danger del-menu" data-id_fm="<?php echo 'fm'.$no; ?>"style="margin-top: 3px;" >Delete Menu</a></div></div>
            <?php $no++; } ?>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
               <input type="hidden" name="id_reservation" id="id_reservation" value="<?php echo $reser[0]->id_reservation; ?>">
    ...
    <script type="text/javascript">
      ...
      $('.menu-test').on('click', function(e){
         let menu_list = $('.menu-list-data');
          ...
          console.log(id);
          ajax_update_reserv(reservation,id);
      });


      function ajax_update_reserv(data,id)
      {
          let url = '<?php echo base_url(); ?>';

          $.ajax({
              url : url +'waiter/backend/update_reservation',
              type : 'POST',
              dataType : 'JSON',
