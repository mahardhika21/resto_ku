...
<body>
  ...
  ?>
    ...
    <div class="content-wrapper" >
        ...
        <h3>FORM PROFILE ADMIN</h3>
        
        <form method="POST" class="form-horizontal" role="form" action="<?php echo site_url('admin/backend/update_profile'); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="datum[nama]" value="<?php echo $profile[0]['nama']; ?>">
            </div>
          </div>
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="hidden" name="email[email_real]" value="<?php echo $email; ?>">
              <input class="form-control" type="text" name="email[email]" value="<?php echo $email; ?>">
            </div>
          </div>
          <div class="form-group">
