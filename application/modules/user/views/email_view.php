...
<body><div class="">
	<div class="aHl"></div>
	<div id=":4x" tabindex="-1"></div>
	<div id=":4m" class="ii gt">
		<div id=":4l" class="a3s aXjCH m16482c900b77fb3a">
							...
							<td>
								...
								<tr>
									...
									<td>
										...
										<tr>
											<td align="left">
												<img height="32" src="" style="width:92px;height:32px" width="92" class="CToWUd">
											</td>
								...
								<tr>
									...
									<td>
										<div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;padding-left:20px;padding-right:20px;border-bottom:thin solid #f0f0f0;color:rgba(0,0,0,0.87);font-size:18px;padding-bottom:38px;padding-top:40px;text-align:center;word-break:break-word">
											<div class="m_2977001422146193064v2sp">
												<?php echo $body; ?>
										...
										<!-- <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:rgba(0,0,0,0.87);line-height:1.6;padding-left:20px;padding-right:20px;padding-bottom:32px;padding-top:24px">
											<div class="m_2977001422146193064v2sp">
												stroom token Listrik PLN prabayar												<div style="padding-top:24px;text-align:center">
	...
	<div id=":51" class="ii gt" style="display:none">
		<div id=":52" class="a3s aXjCH undefined"></div>
	</div>
	<div class="hi"></div>
</div></body></html>